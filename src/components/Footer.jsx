	...
	return (
		<div className="py-5 text-center">
				<div className="container max-w-screen-lg mx-auto">
					<div>
						<div className="flex flex-wrap justify-center gap-2">
							<a 
								href="https://x.com/kpushkar47"
								className="bg-black-100 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded-full">
								<svg
			...
			<p className="text-sm mt-2  opacity-50">
				&copy; {new Date().getFullYear()} Pushkar Kumar. All rights reserved.
			</p>
		</div>
	);
}
